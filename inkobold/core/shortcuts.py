...
DEFAULT_SHORTCUTS: dict[str, list[str]] = {
    ...
    "win.tile_preview": ["<Control><Shift>t"],
    "win.tile_wrap": ["<Control><Shift>w"],
    "win.undo": ["<Control>z"],
    "win.redo": ["<Control><Shift>z", "<Control>y"],
    "win.add_layer": ["<Control><Shift>n"],
    "win.duplicate_layer": ["<Control>j"],
    ...
    "win.tool_pen": ["p"],
    "win.tool_line": ["l"],
    "win.tool_rectangle": ["o"],
    "win.tool_curve": ["u"],
    "win.tool_brush": ["b"],
    "win.tool_weld_brush": ["w"],
    "win.tool_fill": ["g"],
    "win.tool_gradient": ["a"],
    "win.tool_eraser": ["e"],
    "win.tool_smear": ["m"],
    "win.tool_liquify": ["y"],
    "win.tool_replace": ["c", "r"],
    "win.tool_move": ["v"],
    "win.tool_lasso": ["q"],
    "win.tool_pen3d": ["d"],
    "win.tool_fill3d": ["f"],
...
SHORTCUT_LABELS: dict[str, str] = {
    ...
    "win.tile_preview": "Tile Preview",
    "win.tile_wrap": "Wrap Moves",
    "win.undo": "Undo",
    "win.redo": "Redo",
    "win.add_layer": "Add Layer",
    "win.duplicate_layer": "Duplicate Layer",
    ...
    "win.tool_rectangle": "Tool: Rectangle",
    "win.tool_curve": "Tool: Curve",
    "win.tool_brush": "Tool: Brush",
    "win.tool_weld_brush": "Tool: Weld Brush",
    "win.tool_fill": "Tool: Fill",
    "win.tool_gradient": "Tool: Gradient",
